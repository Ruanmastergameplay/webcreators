        ...
        <Reveal>
          <div className="sticky top-[104px] flex min-h-[420px] flex-col justify-end rounded-[22px] border border-white/[0.078] bg-[radial-gradient(circle_at_48%_18%,rgba(255,122,0,.42),transparent_24%),linear-gradient(160deg,#1c282e,#080d10_64%)] p-[clamp(24px,3vw,44px)] min-[992px]:min-h-[560px]">
            ...
            <strong className="mt-4 max-w-[520px] text-[clamp(34px,4vw,64px)] font-normal leading-[0.98] tracking-[-0.04em]">
              Design, tecnologia e funcao pratica.
            </strong>
          </div>
        </Reveal>
        <Reveal delay={1} className="pt-4">
          <p className="eyebrow mb-7">Sobre mim</p>
          <h2 className="title-l">Eu construo sites com mentalidade de evolucao.</h2>
          <div className="mt-8 grid gap-7">
            <p className="lead-text m-0">
              Sou estudante da area de tecnologia e estou construindo minha trajetoria em desenvolvimento web, automacoes e
              solucoes digitais com IA.
            </p>
            <p className="lead-text m-0">
              Meu foco e criar sites que nao sejam apenas bonitos, mas claros, rapidos e uteis para negocios reais.
            </p>
            <p className="lead-text m-0">
              Um bom site precisa juntar tres coisas: visual forte, estrutura simples e funcao pratica.
            </p>
          </div>
        </Reveal>
      </div>
